...
import {
  ...
  type IPrivateEditedMessagePayload, type IPrivateLocationPayload,
  ...
  type IPrivateVoicePayload, type MediaPayload
...
export default class PrivatePayloadCreator extends PrivateUpdateHandler implements IPayloadCreator {
  ...
  public create(updateType: PRIVATE_UPDATE_TYPES, context: Context<Update>): IPrivateContextPayload | null {
    const functionCreator: undefined | PayloadCreatorFunc<IPrivateContextPayload> = this.decoratorCreatorFunctionByUpdateType[updateType];
