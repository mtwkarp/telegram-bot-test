...
import { type UserScheduleObj } from '../../../../commandHandlers/private/handlers/scheduleCommand/ts/schedule_cmd_types';
...
export default class InstructorsAvailabilitySheet extends AbstractScheduleSheet {
  ...
  public async getInstructorsChatIdsWithNoScheduleResponse(): Promise<Array<{ fullName: string, chatId: number }> | []> {
    const rowStart = 2;
    ...
    const instructorsFullNames = await this.usersCollection.getAllDocumentValues('fullNames') as Record<string, string>;
